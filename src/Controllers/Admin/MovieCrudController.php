...
namespace Chilltv\Core\Controllers\Admin;

use Chilltv\Core\Requests\MovieRequest;
 ...
 * @package chilltv\Core\Controllers\Admin
...
class MovieCrudController extends CrudController
{
    ...
    use \Chilltv\Core\Traits\Operations\BulkDeleteOperation {
    ...
    {
        CRUD::setModel(\Chilltv\Core\Models\Movie::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/movie');
        CRUD::setEntityNameStrings('movie', 'movies');
        CRUD::setCreateView('chilltv::movies.create',);
        CRUD::setUpdateView('chilltv::movies.edit',);
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::addColumn([
            ...
            'label' => 'Thông tin',
            'type' => 'view',
            'view' => 'chilltv::movies.columns.column_movie_info',
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            'name' => 'episodes',
            'type' => 'view',
            'view' => 'chilltv::movies.inc.episode',
