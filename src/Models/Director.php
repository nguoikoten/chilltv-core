...
namespace Chilltv\Core\Models;

use Backpack\CRUD\app\Models\Traits\CrudTrait;
use Backpack\Settings\app\Models\Setting;
use Chilltv\Core\Contracts\TaxonomyInterface;
use chilltvpack\CachingModel\Contracts\Cacheable;
use chilltvPack\CachingModel\HasCache;
use Illuminate\Database\Eloquent\Model;
use Chilltv\Core\Contracts\SeoInterface;
use Chilltv\Core\Traits\HasFactory;
use Chilltv\Core\Traits\HasTitle;
use Chilltv\Core\Traits\HasDescription;
use Chilltv\Core\Traits\HasKeywords;
use Chilltv\Core\Traits\HasUniqueName;
use Chilltv\Core\Traits\Sluggable;
...
class Director extends Model implements TaxonomyInterface, Cacheable, SeoInterface
{
    ...
    */
    ...
    {
        return route('directors.movies.index', $this->slug);
    }
